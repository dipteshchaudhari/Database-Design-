...
INSERT INTO userss (name, email, gender, date_of_birth, salary) VALUES
...
-- NOW we have to create one more column named addresses to this table, we can just create a another table with foreign key
